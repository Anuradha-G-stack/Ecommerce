...
public class loginPage extends BasePage {
    ...
    @FindBy (xpath="(//input[@type='button'])[3]")private WebElement clickOnContinue;
	@FindBy (xpath="//input[@id='gc-registration-otp-panel-submit']") private WebElement clickOnSubmitt;
	@FindBy(xpath="//select[@name='fktitle_id']")private WebElement Title;
	@FindBy (xpath="(//input[@class='input_Special'])[1]")private WebElement firstname;
  ...
  public void checkUserIsAbleToEnterTheMoblieNo(CharSequence mobilenumber){
   ...
   public void verifyUserIsableToEnterMobileNumberInMobileNumberField() throws EncryptedDocumentException, IOException{
		String mobilenumber= parametrization.getdata(5,0,"sheet1");
		mobileNo.sendKeys(mobilenumber);
   }
   public void verifyUserIsableToEnterMobilelandlineNumberInlandlineNumberField() throws EncryptedDocumentException, IOException{
