...
public class NaaptalHomePage extends BasePage {
	...
	@FindBy(xpath = "//div[@id='mainMenuContent']//li")
	private WebElement listProduct;
	@FindBy(xpath = "//div[@class='grid_Square ']")
	private List<WebElement> productList;
	@FindBy(xpath = "//a[@class='link_Continue']")
	private WebElement AddToCartpage;
	@FindBy(xpath = "//article[@id='staticContent']//section//h2")
	private WebElement trackOrderPage;
